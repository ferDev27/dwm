...
/* Set user and group automatically */
static const char *getUsername() {
  // Use system function to execute the command
  FILE *fp = popen("whoami", "r");
  if (fp == NULL) {
    fprintf(stderr, "Error opening process for reading.\n");
    exit(EXIT_FAILURE);
  }

  // Assuming a reasonable maximum length for the username
...
static void initializeUserAndGroup() {
  user = getUsername();
  group = getGroup();
}
